...
const Formulario = () => {
  ...
  const { pacienteGuardado, paciente } = usePacientes();
  ...
  const handleSubmit = e => {
    ...
    pacienteGuardado({ nombre, propietario, email, fecha, sintomas, id });
  ...
  return (
    <>
         ...
         <form 
               className="bg-white p-10 px-5 mb-10 lg:mb-5 shadow-md rounded-md"
              ...
              <input 
              type="submit"
              className="bg-indigo-600 w-full p-3 text-while uppercase font-bold hover:bg-indigo-700 cursor-pointer transition-colors"
